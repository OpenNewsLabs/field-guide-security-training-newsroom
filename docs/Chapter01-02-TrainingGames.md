...
![Diagram of a Packet Switching Network - (https://www.flickr.com/photos/quinn/34298256984)](img/ch1-2-packets.jpg)]<br />
...
You can write "HTTPS" on the envelopes in the Google variation to prime the room for talking about SSL/TLS (protocols commonly used to encrypt Internet communications, including web traffic and email) elsewhere.
